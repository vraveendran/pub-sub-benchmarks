...
public class PulsarClientConfig {
    private static Properties baseConfig() {
        ...
        jaasConfig.append(String.format("username='%s' ", System.getenv("PULSAR_USERNAME")));
        jaasConfig.append(String.format("password='%s';", System.getenv("PULSAR_PASSWORD")));
        ...
        // props.put("ssl.truststore.password", System.getenv("PULSAR_TRUSTSTORE_PASSWORD"));
        // props.put("ssl.keystore.location", "");
        // props.put("ssl.keystore.password", System.getenv("PULSAR_KEYSTORE_PASSWORD"));
